...
filepath = 'D:/satis/Plant-Leaf-Disease-Prediction-main/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('D:/satis/Plant-Leaf-Disease-Prediction-main/Dataset/test/Tomato___Septoria_leaf_spot (1)')
